...
export default function LandingPage() {
  return (
    <div className="relative min-h-screen w-full flex flex-col items-center justify-center bg-background p-4 overflow-hidden">
      ...
      <footer className="z-10 mt-16 text-center text-muted-foreground text-sm">
